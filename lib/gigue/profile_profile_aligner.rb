    ...
    inline(:C) do |builder|
      ...
      builder.c_raw <<-EOCPP
        static VALUE local_alignment_linear_gap_cpp(int argc, VALUE *argv, VALUE self) {
          ...
          return rb_class_new_instance(6, args, rb_path2class("ProfileProfileLocalAlignmentLinearGap"));
        }
      EOCPP
    end
    ...
    inline(:C) do |builder|
      ...
      builder.c_raw %q{
        static VALUE local_alignment_affine_gap_cpp(int argc, VALUE *argv, VALUE self) {
          ...
          return rb_class_new_instance(13, args, rb_path2class("ProfileProfileLocalAlignmentAffineGap"));
        }
      }
    end
    ...
    inline(:C) do |builder|
      ...
      builder.c_raw <<-EOCPP
        static VALUE global_alignment_linear_gap_cpp(int argc, VALUE *argv, VALUE self) {
          ...
          return rb_class_new_instance(4, args, rb_path2class("ProfileProfileGlobalAlignmentLinearGap"));
        }
      EOCPP
    end
    ...
    inline(:C) do |builder|
      ...
      builder.c_raw %q{
        static VALUE global_alignment_affine_gap_cpp(int argc, VALUE *argv, VALUE self) {
          ...
          return rb_class_new_instance(11, args, rb_path2class("ProfileProfileGlobalAlignmentAffineGap"));
        }
      }
    end
